...
public:
    ...
    // Filters
    bool filterNewDevice(int fd, int32_t id, const String8& path,
    ...
    // Local APIs
    void registerDevice(
            const vendor::nvidia::hardware::shieldtech::inputflinger::V2_0::NewDevice& newDevice);
...
private:
    ...
    InputDeviceIdentifier* getInputDeviceIdentifier(
            const vendor::nvidia::hardware::shieldtech::inputflinger::V2_0::InputIdentifier& ident);
};
