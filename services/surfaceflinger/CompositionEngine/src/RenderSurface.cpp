...
constexpr auto kPropNativeWindowBuffersFormat = "ro.surface_flinger.native_window_buffers_format";

int getNativeWindowBuffersFormat(void) {
    return android::base::GetIntProperty<int>(kPropNativeWindowBuffersFormat,
