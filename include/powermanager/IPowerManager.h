...
public:
    ...
    enum {
        ...
        GO_TO_SLEEP                  = IBinder::FIRST_CALL_TRANSACTION + 10,
        NAP                          = IBinder::FIRST_CALL_TRANSACTION + 11,
        IS_INTERACTIVE               = IBinder::FIRST_CALL_TRANSACTION + 12,
        IS_POWER_SAVE_MODE           = IBinder::FIRST_CALL_TRANSACTION + 13,
        GET_POWER_SAVE_STATE         = IBinder::FIRST_CALL_TRANSACTION + 14,
        SET_POWER_SAVE_MODE_ENABLED  = IBinder::FIRST_CALL_TRANSACTION + 15,
        REBOOT                       = IBinder::FIRST_CALL_TRANSACTION + 22,
        REBOOT_SAFE_MODE             = IBinder::FIRST_CALL_TRANSACTION + 24,
        SHUTDOWN                     = IBinder::FIRST_CALL_TRANSACTION + 25,
        CRASH                        = IBinder::FIRST_CALL_TRANSACTION + 26,
    };
