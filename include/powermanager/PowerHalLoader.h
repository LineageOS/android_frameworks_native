...
public:
    ...
    static sp<vendor::lineage::power::V1_0::ILineagePower> loadLineageHidlV1_0();
...
private:
    ...
    static sp<vendor::lineage::power::V1_0::ILineagePower> gHalLineageHidlV1_0 GUARDED_BY(gHalMutex);
